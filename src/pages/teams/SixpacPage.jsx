...
export default function CombatPage() {
  ...
  return (
    <div className="flex flex-col items-center bg-[linear-gradient(180deg,#4F4B60_0%,#6D6886_20%,#575078_34%,#36397E_98%)] min-h-[2575px]">
      ...
      <div className="relative w-full min-h-0 sm:min-h-[2375px] mt-[-20px] pt-[40px] sm:pt-[230px] pb-[40px] sm:pb-0 flex flex-col items-center">
        <div
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-center pt-[10px] sm:pt-[100px] gap-[40px] sm:gap-[60px] md:gap-[125px] px-6 sm:px-12 md:px-0">
          ...
          <div className="hidden md:block w-full max-w-[600px] h-[580px]">
            <img
              src={featureImage}
