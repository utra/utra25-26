...
export default function OutreachPage() {
  ...
  return (
    ...
    <div className="flex flex-col items-center bg-[linear-gradient(180deg,#4F4B60_0%,#6D6886_20%,#575078_34%,#36397E_98%)] min-h-[1350px]">
      ...
      <div className="relative w-full min-h-0 sm:min-h-[1150px] mt-[-20px] pt-[40px] sm:pt-[230px] pb-[40px] sm:pb-0 flex flex-col items-center">
        <div
